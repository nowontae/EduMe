...
public class TeacherPaymentRequestDTO {
	...
	public TeacherPaymentRequestDTO() {
		super();
	}
	public TeacherPaymentRequestDTO(int pay_idx, int midx, int pay_amount, Date pay_reqDate, Date pay_date,
			String tbank, String tacctname, String tacctnum) {
		super();
