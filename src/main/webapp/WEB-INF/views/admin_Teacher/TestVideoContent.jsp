...
<table>
	...
	<tr>
		<td height="41"  style="border-bottom: 1px solid #bcbcbc;">${dto.tvsubject }</td>
	</tr>
	<tr>
		<td align="right" height="41" style="border-bottom: 1px solid #bcbcbc;"><fmt:formatDate  pattern="yyyy년 MM월 dd일 HH:mm:ss" value="${dto.tvwritedate }"/></td>
	</tr>
	<tr>
