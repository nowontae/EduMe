...
<div class="all">
	...
	<form name="userInfoList" action="admin_userInfoList.do">
		...
		<input type="text" id="findKeys" name="findKeys" pattern="[0-9]+" placeholder="숫자만 입력해주세요." required="required" style=" border-radius:10px; outline:none; width:220px; padding-left: 13px;" >
