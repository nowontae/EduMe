...
<div class="all">
	...
	<div class="content">
		...
		<form name="userInfoList" action="admin_userInfoList.do">
			...
			<input type="text" id="findKeys" name="findKeys" pattern="[0-9]+" placeholder="숫자만 입력해주세요." required="required" style=" border-radius:10px; outline:none; width:220px; padding-left: 13px;     border: 1px solid;" >
			<input type="submit" class="search_button" value="검색">
		</form>
		<br>
			
		<!-- 전체 유저 정보 -->
		<table class="table"><!--  border="1" cellspacing="0" width="1200px" >-->
			<thead>
				<tr>
					<th scope="col">회원 번호</th>
					<th scope="col">프로필사진경로</th>
			...
			<c:forEach var="dto" items="${list }">
				...
				<tr>
					...
					<td><img src="${dto.mimg }" alt="유저 이미지" width="100px"></td>
					<td>
