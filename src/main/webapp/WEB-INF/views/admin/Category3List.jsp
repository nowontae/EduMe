...
<body>
<div style="width: 1200px; background-color:#CDB79E; height: 40px; display: table-cell;   vertical-align: middle;"><a href="CategoryCheck.do">대분류</a> > <a href="javascript:history.back();">중분류</a> > <b>소분류</b></div>
...
<br>
	<tr>
		<td colspan="2">등록된 카테고리(소분류)가 없습니다.</td>
	</tr>
</c:if>
