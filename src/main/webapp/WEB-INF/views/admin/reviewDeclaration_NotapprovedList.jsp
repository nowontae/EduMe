...
&nbsp;&nbsp;&nbsp;<a href="admin_reviewDeclaration.do">전체보기 &nbsp; |&nbsp; <a href="reviewDeclaration_CheckedinformationList.do">확인 전인 것들 0</a> &nbsp;   | &nbsp; <a href="admin_reviewDeclaration_approvedList.do">승인 내역 조회 Y</a> &nbsp; |&nbsp;  <a href="admin_reviewDeclaration_NotapprovedList.do"><b>미승인 내역 조회 N</b></a>
</div>
